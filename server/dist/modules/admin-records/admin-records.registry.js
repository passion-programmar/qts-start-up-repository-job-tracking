...
exports.RECORD_CATEGORIES = void 0;
exports.getRecordCategory = getRecordCategory;
exports.listRecordCategoryIds = listRecordCategoryIds;
const READONLY = { editable: false };
exports.RECORD_CATEGORIES = [
    {
        id: 'accounts',
        label: 'Accounts',
...
const CATEGORY_MAP = new Map(exports.RECORD_CATEGORIES.map((category) => [category.id, category]));
function getRecordCategory(id) {
    return CATEGORY_MAP.get(id) ?? null;
}
function listRecordCategoryIds() {
    return exports.RECORD_CATEGORIES.map((category) => category.id);
}
//# sourceMappingURL=admin-records.registry.js.map